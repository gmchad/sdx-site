...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative border-t border-white/5 mt-16 overflow-hidden">
      {/* Ghosted SDx letterform */}
      <div
        aria-hidden="true"
        className="absolute -right-[5vw] top-1/2 -translate-y-1/2 font-display text-[20vw] font-bold text-white/[0.02] select-none pointer-events-none leading-none"
      >
        SDx
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <span className="font-display text-2xl text-white/80 tracking-tight mb-4 inline-block">SDx</span>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <Link
                href="https://twitter.com/SDxCommunity"
                target="_blank"
              ...
              <Link
                href="https://linkedin.com/company/sdxcommunity"
                target="_blank"
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs uppercase tracking-widest text-white/30 mb-4">Navigate</h3>
          ...
          {/* Community */}
          <div>
            <h3 className="text-xs uppercase tracking-widest text-white/30 mb-4">Community</h3>
            <ul className="space-y-2">
              {[
                { href: 'https://lu.ma/sdx', label: 'Events Calendar', external: true },
                { href: 'https://discord.gg/Rkgyzx2ykV', label: 'Discord', external: true },
                { href: '/executives', label: 'Executive Network', external: false },
                { href: 'mailto:community@sdx.community', label: 'Contact', external: false },
              ].map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    ...
                    onClick={() => link.external && handleLinkClick(link.href, `footer-${link.label.toLowerCase()}`)}
                  >
                    {link.label}
                  </Link>
                </li>
